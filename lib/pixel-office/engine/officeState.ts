...
const CODE_SNIPPETS_ZH_TW = [
  ...
  // Hermes CLI
  'hermes status', 'hermes gateway start', 'hermes gateway restart',
  'hermes logs', 'hermes doctor', 'hermes config get',
  'hermes message send', 'hermes skills', 'hermes models', 'hermes update',
]
